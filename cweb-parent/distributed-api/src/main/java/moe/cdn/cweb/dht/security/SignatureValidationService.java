...
public interface SignatureValidationService {
    /**
     * Validates that the signature's public key exists in the trust network, the signature is
     * owned by the user, and that the signature signs the message.
     *
    ...
    /**
     * Affirms that the signature is owned by the user and that the signature signs the message.
     *
     * @param signature the signature protobuf
    ...
    /**
     * Validates that the signature's public key exists in the trust network, the signature is
     * owned by the user, and that the signature signs the data.
     *
     * @param signature the signature protobuf
     * @param data      the data to validate
     * @return {@code true} if the message is signed by the signature
