...
public class FileIdExtractorTest {
	...
	@Test
	public void test521TextbookSHA1() throws NoSuchAlgorithmException,
			IOException {
	...
	@Test
	public void testThrowsIOExceptionWhenFileIsntThere()
	...
	public void testMagnetUriParsing() throws URISyntaxException, UnsupportedEncodingException {
		String uri = "magnet:?xt=urn:btih:6bf4fe3317bd2a9729a1df7f9e37a5b749869f32&dn=Artificial%20Intelligence%20A%20Modern%20Approach%203rd%20Edition.pdf&tr=udp%3A%2F%2Fopen.demonii.com%3A1337%2Fannounce&tr=udp%3A%2F%2Ftracker.publicbt.com%3A80%2Fannounce&tr=udp%3A%2F%2Ftracker.openbittorrent.com%3A80%2Fannounce&tr=udp%3A%2F%2Ftracker.istole.it%3A80%2Fannounce";
		assertEquals("6bf4fe3317bd2a9729a1df7f9e37a5b749869f32", FileIdExtractor.getIdFromMagnetLink(uri));
	}
	
	@Test
	public void testTorrentAndMagnetMatch() throws URISyntaxException, NoSuchAlgorithmException, IOException {
		String uri = "magnet:?xt=urn:btih:6bf4fe3317bd2a9729a1df7f9e37a5b749869f32&dn=Artificial%20Intelligence%20A%20Modern%20Approach%203rd%20Edition.pdf&tr=udp%3A%2F%2Fopen.demonii.com%3A1337%2Fannounce&tr=udp%3A%2F%2Ftracker.publicbt.com%3A80%2Fannounce&tr=udp%3A%2F%2Ftracker.openbittorrent.com%3A80%2Fannounce&tr=udp%3A%2F%2Ftracker.istole.it%3A80%2Fannounce";
		File f = new File("src/test/resources/test.torrent");
		assertEquals(FileIdExtractor.getIdFromTorrentFile(f), FileIdExtractor.getIdFromMagnetLink(uri));
	}
}
