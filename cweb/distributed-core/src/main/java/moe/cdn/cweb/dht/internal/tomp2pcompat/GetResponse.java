...
public interface GetResponse {
     ...
     * @param rawDigest        The hashes of the content stored with information from which
     *                         peer it has
     *                         been received.
     * @param rawStatus
    ...
    /**
     * @return The raw digest information with hashes of the content and the information
     * which peer has been contacted
     */
    ...
    /**
     * Return the digest information from the get() after evaluation. The evaluation gets rid
     * of the PeerAddress
    ...
    /**
     * Return the data from get() after evaluation. The evaluation gets rid of the
     * PeerAddress information, by either a
    ...
    /**
     * Checks if the minimum of expected results have been reached. This flag is also used for
